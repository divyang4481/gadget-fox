...
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
    <link href="css/gadgetfox.css" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <asp:Panel ID="pnlIM" runat="server">
        ...
        <div id="columns">
            <div id="side">
                <asp:LinkButton ID="btnPersonalInfo" runat="server" PostBackUrl="~/EditPersonalInformation.aspx">Edit Personal Information</asp:LinkButton>
                <br />
